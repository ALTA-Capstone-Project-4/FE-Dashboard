    ...
    <div>
      ...
      <div className="container after-navbar pb-5 mb-5">
        ...
        {myRoom.map((item, index) => {
          ...
          return (
            <div key={index} style={{ borderWidth: "2px", borderStyle: "solid", borderRadius: "5px" }} className="yellow-font p-2 row d-flex my-4">
              ...
              <div className="col  black-font">
                ...
                <p className="pt-1">
                  Luas: {item.luas_lahan} m<sup>2</sup>
                </p>
              ...
              <div className="col  black-font">
                ...
                <div className="pt-4 white-font text-center">
                  {item.status_pembayaran === "paid" ? (
                    <div className="button-search green-background py-1 mt-4">Status Sewa: Disewa</div>
                  ) : item.status_pembayaran === "pending" ? (
                    <div className="button-search yellow-background py-1 mt-4">Status Pembayaran: Menunggu Pembayaran</div>
                  ) : item.status_pembayaran === "failed" ? (
                    <div className="button-search red-background py-1 mt-4">Status Sewa: Gagal Dibayar</div>
                  ) : item.status_pembayaran === "expired" ? (
                    <div className="button-search bg-primary py-1 mt-4">Status Sewa: Selesai Disewa</div>
                  ) : null}
                </div>
              </div>
            </div>
