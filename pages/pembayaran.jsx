        ...
        <div className="container pb-5 after-navbar ">
            ...
            <div style={{ borderWidth: '2px', borderStyle: 'solid', borderRadius: '5px'}} className="yellow-font p-5">
                <div className="black-font">
                    <p className="fs-5">Pembayaran: {(data.bank).toUpperCase()}</p>
            ...
            <button className="button-search px-5 py-1 green-background fw-semibold" onClick={paid}>Sudah Bayar</button>
            </div>
        </div>
        <Footer/>
    </div>
